...
struct SampleTestCase
{
    ...
    ProducerType sutProducer{UsedChunk{chunkMock.chunkHeader(), 0U}, [](DummyData*) {}, mockInterface};
    ProducerType sutProducerForMove{UsedChunk{chunkMockForMove.chunkHeader(), 0U}, [](DummyData*) {}, mockInterface};
    ConsumerType sutConsumer{UsedChunk{chunkMock.chunkHeader(), 0U}, [](const DummyData*) {}};
    ConsumerType sutConsumerForMove{UsedChunk{chunkMockForMove.chunkHeader(), 0U}, [](const DummyData*) {}};
};
